...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM guru WHERE username = ? AND password = ? AND role = 'walikelas'");
    $stmt->execute([$username, $password]);
    $walikelas = $stmt->fetch();

    if ($walikelas) {
        $_SESSION['walikelas_id'] = $walikelas['id'];
        header("Location: home_walikelas.php");
        exit;
    } else {
...
<head>
    ...
    <title>Login Walikelas - SMK Negeri 2 Magelang</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl card-shadow p-8 border border-gray-100">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-primary-blue mb-2">Login Walikelas</h2>
                <p class="text-gray-600">Masuk ke dashboard walikelas</p>
            </div>
            ...
            <div class="mt-6 text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="login_guru.php" class="text-primary-blue hover:text-blue-700 transition-all duration-300 flex items-center">
                        <i class="fas fa-chalkboard-teacher mr-2"></i>
                        Login sebagai Guru
                    </a>
                    <a href="login_siswa.php" class="text-primary-blue hover:text-blue-700 transition-all duration-300 flex items-center">
