...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM siswa WHERE nis = ? AND nama = ?");
...
<head>
    ...
    <title>Login Siswa - SMK Negeri 2 Magelang</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl card-shadow p-8 border border-gray-100">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-primary-blue mb-2">Login Siswa</h2>
                <p class="text-gray-600">Masuk untuk melihat nilai</p>
            </div>
            ...
            <div class="mt-6 text-center">
                ...
                <a href="login_guru.php" class="text-primary-blue hover:text-blue-700 transition-all duration-300 flex items-center justify-center">
